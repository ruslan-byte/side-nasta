<template>
  <div class="py-8">
    <div class="g-container">
      ...
      <div
        id="contacts"
        class="mb-4 rounded border border-primary p-4 text-main flex items-center"
      >
        <div class="mr-4">Записатся на бесплатный пробный урок-знакомство</div>
        <div class="flex">
          <Button class="mb-2 lg:mr-4 lg:mb-0">Телеграм</Button>
          <Button class="">ВКонтакте</Button>
        </div>
      </div>
      <p class="mb-6">
      ...
      <about-me-feature-slider class="mb-6 lg:mb-8" />
      <about-me-resilt class="mb-6" />
      <about-me-prices class="mb-6" />
      <Button class="w-full"> Записатся </Button>
    </div>
  </div>
</template>
